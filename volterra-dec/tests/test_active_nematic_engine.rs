...
use volterra_dec::stokes_trait::KillingOperatorSolver;
use volterra_dec::{ActiveNematicEngine, EngineParams};
...
fn test_engine_stream_function_backend() {
    ...
    use volterra_dec::stokes_trait::StreamFunctionStokes;
    ...
    let stokes: Box<dyn volterra_dec::StokesSolver> = Box::new(sf);
