//! Integration test for the `FdStep` `PhysicsStep` adapter.
//!
//! Verifies that `FdStep` routes one finite-difference advance through
...
#[test]
fn fd_step_advances_and_reports_finite_stats() {
    let lx = 16;
    let ly = 16;
