//! Error type for the 2D finite-difference solver.

use std::path::PathBuf;

/// Errors raised by the solver: I/O, configuration and numerical checks.
///
...
pub enum Fd2dError {
    ...
    #[error("fd2d I/O error at {path}: {source}")]
    Io {
    ...
    #[error("fd2d configuration error: {0}")]
    Config(String),
...
pub type Fd2dResult<T> = Result<T, Fd2dError>;
