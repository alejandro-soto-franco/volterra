//! Integration test for the `Fd2dStep` `PhysicsStep` adapter.
//!
//! Verifies that `Fd2dStep` routes one finite-difference advance through
...
#[test]
fn fd2d_step_advances_and_reports_finite_stats() {
    let lx = 16;
    let ly = 16;
