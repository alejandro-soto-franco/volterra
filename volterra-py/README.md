...
|-------------|-------------|
| `volterra.MarsParams` | Physical and numerical parameters |
...
| `volterra.run_mars_component1` | Component 1 (dry active nematic) runner |
...
snapshots = volterra.run_mars_component1(params, n_steps=10000, snap_every=500)
```
