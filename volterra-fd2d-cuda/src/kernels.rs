...
//! as `v[(x * ly + y) * 2 + c]`, `c` in `{0, 1}` (`volterra_fd2d::index`). The
...
pub mod kernels {
    ...
    ///
    /// Ports `volterra_fd2d::ops::laplacian`, including its `/6` normalisation
    ...
    ///
    /// Ports `volterra_fd2d::ops::laplacian_vector`. One thread per cell writes
    ...
    ///
    /// Ports `volterra_fd2d::ops::div_vector`.
    #[kernel]
    pub fn div_vector(
        arr: &[f64],
        inside: &[u8],
    ...
    ///
    /// Ports `volterra_fd2d::ops::upwind_advective_term`: adds
    ...
    ///
    /// Ports `volterra_fd2d::nematic::h_s_from_q`, which the CPU runs as two
    ...
    ///
    /// Ports `volterra_fd2d::nematic::calculate_pi`, which the CPU runs as four
    ...
    ///
    /// Ports `volterra_fd2d::stokes::relax_pressure_inner_loop`. Reads only
    ...
    ///
    /// Ports `volterra_fd2d::stokes::calculate_pressure_terms`, which
    ...
    ///
    /// Ports `volterra_fd2d::stokes::get_u_update`, which the CPU runs as three
    ...
    ///
    /// Ports `volterra_fd2d::bc::apply_u_boundary_conditions`, which sets both
    ...
    ///
    /// Ports `volterra_fd2d::bc::apply_q_boundary_conditions`. The director
    ...
    /// wall.
    ///
    /// Ports `volterra_fd2d::bc::apply_h_boundary_conditions`. The one-sided
    ...
    ///
    /// Ports `volterra_fd2d::bc::apply_p_boundary_conditions`, including the
    ...
    ///
    /// Ports `volterra_fd2d::step::get_q_update`: `dQ = H/gamma + S` at every
