...
//! `rustc-codegen-cuda`).
//!
//! `volterra_fd2d` is the CPU reference. Every kernel here ports one of its
...
//! 500,000 times, and `volterra_fd2d` takes the serial path at that size
...
//! # State
//!
//! Every stage of `volterra_fd2d::step::update_step_inner` has a kernel here,
